...
export const Sidebar: React.FC = () => {
  ...
  const entrepreneurItems = [
    ...
    { to: "/payments", icon: <BadgeDollarSign size={20} />, text: "Payments" },
  ];
  ...
  const commonItems = [
    ...
    { to: "/demo", icon: <Presentation size={20} />, text: "Demo Guide" },
    { to: "/settings", icon: <Settings size={20} />, text: "Settings" },
    { to: "/help", icon: <HelpCircle size={20} />, text: "Help & Support" },
  ];

  return (
    <div className="w-64 bg-white h-full border-r border-gray-200 hidden md:block shadow-[0_0_40px_rgba(15,23,42,0.04)]">
