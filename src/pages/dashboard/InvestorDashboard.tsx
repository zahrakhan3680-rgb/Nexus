...
import { confirmedMeetings, walletSummary } from "../../data/platform";
      ...
      <div className="grid gap-4 md:grid-cols-3">
        <Card className="border border-gray-200 bg-white shadow-sm">
          <CardBody>
            ...
            <p className="mt-1 text-sm text-gray-600">
              Reserved for current deal flow: {walletSummary.reserved}
            </p>
          </CardBody>
        </Card>
        ...
        <Card className="border border-gray-200 bg-white shadow-sm">
          <CardBody>
            ...
            <p className="mt-1 text-sm text-gray-600">
              Calendar and call rooms are live in the nav.
            </p>
          </CardBody>
        </Card>
        ...
        <Card className="border border-gray-200 bg-white shadow-sm">
          <CardBody>
            <p className="text-sm font-medium text-gray-500">Open modules</p>
            <div className="mt-3 flex flex-wrap gap-2">
              ...
              <Link to="/payments">
                <Badge variant="accent">Payments</Badge>
              </Link>
            </div>
          </CardBody>
        </Card>
